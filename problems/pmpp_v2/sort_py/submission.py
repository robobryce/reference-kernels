...
Micro-optimizations:
- sm_100a arch target for 8-byte shared memory banks on B200
- int32 bitcast (no float dispatch)
- persistent temp at module init
- direct output write
...
sort_module = load_inline(
    ...
    extra_cuda_cflags=['--gpu-architecture=sm_100a'],
    verbose=False,
)
...
def custom_kernel(data: input_t) -> output_t:
    ...
    sm_100a arch target for 8-byte shared memory banks.
    """
